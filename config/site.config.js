...
module.exports = {
  ...
  // userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '2637053537@qq.com',
  userPrincipalName: '2637053537@qq.com',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: '/icons/xiaoliuya.jpg',

  // Prefix for KV Storage
  kvPrefix: process.env.KV_PREFIX || '',

  // The name of your website. Present alongside your icon.
  title: "kannong_xi's OneDrive",
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/kannong?tab=repositories',
    },
    {
      name: '博客',
      link: 'https://kannong.kanxiyewords.cn/',
    },
  ],
